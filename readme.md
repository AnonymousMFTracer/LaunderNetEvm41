### Overview
This is an anonymous repository publicly releasing the dataset LaunderNetEvm41 contributed by the paper *Shedding Light on Shadows: Automatically Tracing Illicit Money Flows on EVM-Compatible Blockchains*.
